...
import { makeComboLeague, makeBackButton } from "./common.js"; //TODO: a extinguir, crear clases
...
class NewsScreen extends Screen {
    ...
    buildHeader() {
        ...
        //añade listeners en News al combobox de ligas
    ...
    //sobreescribimos el metodo buildMain para construir la seccion <main> de news
    buildMain() {
        super.buildMain();
